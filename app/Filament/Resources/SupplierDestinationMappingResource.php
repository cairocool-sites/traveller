...
use App\Filament\Resources\SupplierDestinationMappingResource\Pages\EditSupplierDestinationMapping;
use App\Filament\Resources\SupplierDestinationMappingResource\Pages\ListSupplierDestinationMappings;
...
class SupplierDestinationMappingResource extends Resource
{
    protected static ?string $model = SupplierDestinationMapping::class;
    ...
    {
        return __('admin.supplier_destination_mappings.model_label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('admin.supplier_destination_mappings.plural_model_label');
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('local_entity_type')->label(__('admin.supplier_mappings.fields.local_entity_type'))->sortable(),
                TextColumn::make('local_entity_id')->label(__('admin.supplier_mappings.fields.local_entity_id'))->sortable(),
                TextColumn::make('supplier_destination_code')->label(__('admin.supplier_destination_mappings.fields.destination_code'))->searchable()->copyable(),
    ...
    {
        return [
            'index' => ListSupplierDestinationMappings::route('/'),
            'edit' => EditSupplierDestinationMapping::route('/{record}/edit'),
        ];
    }
}
