        ...
        <div class="grid gap-8 lg:grid-cols-[1fr_360px]">
            <div>
                ...
                <p class="mt-5 text-base font-semibold text-slate-600">
                    ...
                    @if ($canonicalHotel?->star_rating ?? $result['star_rating'] ?? null) · {{ $canonicalHotel?->star_rating ?? $result['star_rating'] }} {{ __('public.results.stars') }} @endif
                </p>
                <p class="mt-4 max-w-3xl text-base leading-8 text-slate-700">{{ $translation?->description ?? $translation?->short_description ?? $supplierDetails?->hotel->name ?? $result['name'] }}</p>
            ...
            <aside class="space-y-4">
                ...
                <div class="cct-card p-5">
                    ...
                    <p class="mt-2 text-sm leading-6 text-slate-600">{{ $canonicalHotel?->address_line_1 ?? $result['location'] }}</p>
                </div>
            </aside>
        </div>
    </section>
